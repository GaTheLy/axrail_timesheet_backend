...
<head>
    ...
    <title>Reset Password — TimeFlow</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-link { display: block; text-align: center; margin-top: 1.25rem; color: var(--color-primary); text-decoration: none; font-size: 0.875rem; font-weight: 500; }
...
<body>
    <main class="login-container" role="main">
        ...
        <div class="login-card">
            ...
            <p class="subtitle">Enter the verification code sent to your email along with your new password.</p>
