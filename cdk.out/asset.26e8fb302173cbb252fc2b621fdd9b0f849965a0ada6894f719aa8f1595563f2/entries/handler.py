...
def _validate_submission_editable(submission):
    """Validate that the submission status allows edits.

    Validates: Requirements 6.5 — entries only editable when Draft or Rejected.

    Args:
        submission: The submission item dict.

    Raises:
        ValueError: If the submission status does not allow edits.
    """
